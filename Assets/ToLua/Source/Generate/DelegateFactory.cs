...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(UnityEngine.Events.UnityAction<AssetLoader>), factory.UnityEngine_Events_UnityAction_AssetLoader);
		...
		DelegateTraits<UnityEngine.Events.UnityAction<AssetLoader>>.Init(factory.UnityEngine_Events_UnityAction_AssetLoader);
		...
		TypeTraits<UnityEngine.Events.UnityAction<AssetLoader>>.Init(factory.Check_UnityEngine_Events_UnityAction_AssetLoader);
		...
		StackTraits<UnityEngine.Events.UnityAction<AssetLoader>>.Push = factory.Push_UnityEngine_Events_UnityAction_AssetLoader;
	...
	class UnityEngine_Events_UnityAction_AssetLoader_Event : LuaDelegate
	{
		public UnityEngine_Events_UnityAction_AssetLoader_Event(LuaFunction func) : base(func) { }
		public UnityEngine_Events_UnityAction_AssetLoader_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(AssetLoader param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(AssetLoader param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public UnityEngine.Events.UnityAction<AssetLoader> UnityEngine_Events_UnityAction_AssetLoader(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UnityEngine.Events.UnityAction<AssetLoader> fn = delegate(AssetLoader param0) { };
			return fn;
		}

		if(!flag)
		{
			UnityEngine_Events_UnityAction_AssetLoader_Event target = new UnityEngine_Events_UnityAction_AssetLoader_Event(func);
			UnityEngine.Events.UnityAction<AssetLoader> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UnityEngine_Events_UnityAction_AssetLoader_Event target = new UnityEngine_Events_UnityAction_AssetLoader_Event(func, self);
			UnityEngine.Events.UnityAction<AssetLoader> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_UnityEngine_Events_UnityAction_AssetLoader(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(UnityEngine.Events.UnityAction<AssetLoader>), L, pos);
	}

	void Push_UnityEngine_Events_UnityAction_AssetLoader(IntPtr L, UnityEngine.Events.UnityAction<AssetLoader> o)
	{
		ToLua.Push(L, o);
	}
